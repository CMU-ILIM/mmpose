...
class TopDownCarFusionDataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    CarFusion keypoint indexes::
        0: 'Right Front wheel',
        1: 'Left Front wheel'
        2: 'Right Back wheel'
        3: 'Left Back wheel'
        4: 'Right Front HeadLight'
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/carfusion.py')
    ...
    def _get_db(self):
        ...
        if (not self.test_mode) or self.use_gt_bbox:
            ...
            gt_db = self._load_carfusion_keypoint_annotations()
        else:
            # use bbox from detection
            gt_db = self._load_carfusion_vehicle_detection_results()
        return gt_db

    def _load_carfusion_keypoint_annotations(self):
    ...
    def evaluate(self, results, res_folder=None, metric='mAP', **kwargs):
        ...
        self._write_carfusion_keypoint_results(valid_kpts, res_file)
    ...
    def _write_carfusion_keypoint_results(self, keypoints, res_file):
